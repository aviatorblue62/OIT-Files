...
SET USER_VM_OPTIONS_FILE=%USERPROFILE%\.PyCharm40\pycharm%BITS%.exe.vmoptions
...
SET COMMON_JVM_ARGS="-XX:ErrorFile=%USERPROFILE%\java_error_in_PYCHARM_%%p.log" "-Xbootclasspath/a:%IDE_HOME%/lib/boot.jar" -Didea.paths.selector=PyCharm40 %IDE_PROPERTIES_PROPERTY%
